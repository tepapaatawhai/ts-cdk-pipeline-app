...
| <code><a href="#ts-cdk-pipeline-app.CDKPipelineApp.addBins">addBins</a></code> | *No description.* |
...
| <code><a href="#ts-cdk-pipeline-app.CDKPipelineApp.property.artifactsJavascriptDirectory">artifactsJavascriptDirectory</a></code> | <code>string</code> | The location of the npm tarball after build (`${artifactsDirectory}/js`). |
...
##### `postCompileTask`<sup>Required</sup> <a name="postCompileTask" id="ts-cdk-pipeline-app.CDKPipelineApp.property.postCompileTask"></a>
...
##### ~~`manifest`~~<sup>Required</sup> <a name="manifest" id="ts-cdk-pipeline-app.CDKPipelineApp.property.manifest"></a>
...
| <code><a href="#ts-cdk-pipeline-app.CDKPipelineAppOptions.property.autoMergeOptions">autoMergeOptions</a></code> | <code>projen.github.AutoMergeOptions</code> | Configure options for automatic merging on GitHub. |
...
| <code><a href="#ts-cdk-pipeline-app.CDKPipelineAppOptions.property.license">license</a></code> | <code>string</code> | License's SPDX identifier. |
...
| <code><a href="#ts-cdk-pipeline-app.CDKPipelineAppOptions.property.releaseEveryCommit">releaseEveryCommit</a></code> | <code>boolean</code> | Automatically release new versions every commit to one of branches in `releaseBranches`. |
...
| <code><a href="#ts-cdk-pipeline-app.CDKPipelineAppOptions.property.jest">jest</a></code> | <code>boolean</code> | Setup jest unit tests. |
...
| <code><a href="#ts-cdk-pipeline-app.CDKPipelineAppOptions.property.projenrcTsOptions">projenrcTsOptions</a></code> | <code>projen.typescript.ProjenrcOptions</code> | Options for .projenrc.ts. |
...
##### `devDeps`<sup>Optional</sup> <a name="devDeps" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.devDeps"></a>
...
##### `entrypoint`<sup>Optional</sup> <a name="entrypoint" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.entrypoint"></a>
...
##### `homepage`<sup>Optional</sup> <a name="homepage" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.homepage"></a>
...
##### `keywords`<sup>Optional</sup> <a name="keywords" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.keywords"></a>
...
##### `license`<sup>Optional</sup> <a name="license" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.license"></a>
...
##### `licensed`<sup>Optional</sup> <a name="licensed" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.licensed"></a>
...
##### `maxNodeVersion`<sup>Optional</sup> <a name="maxNodeVersion" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.maxNodeVersion"></a>
...
##### `minNodeVersion`<sup>Optional</sup> <a name="minNodeVersion" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.minNodeVersion"></a>
...
##### `npmAccess`<sup>Optional</sup> <a name="npmAccess" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.npmAccess"></a>
...
##### ~~`npmRegistry`~~<sup>Optional</sup> <a name="npmRegistry" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.npmRegistry"></a>
...
##### `npmRegistryUrl`<sup>Optional</sup> <a name="npmRegistryUrl" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.npmRegistryUrl"></a>
...
##### `npmTokenSecret`<sup>Optional</sup> <a name="npmTokenSecret" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.npmTokenSecret"></a>
...
##### `packageManager`<sup>Optional</sup> <a name="packageManager" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.packageManager"></a>
...
##### `packageName`<sup>Optional</sup> <a name="packageName" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.packageName"></a>
...
##### `peerDependencyOptions`<sup>Optional</sup> <a name="peerDependencyOptions" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.peerDependencyOptions"></a>
...
##### `peerDeps`<sup>Optional</sup> <a name="peerDeps" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.peerDeps"></a>
...
##### `pnpmVersion`<sup>Optional</sup> <a name="pnpmVersion" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.pnpmVersion"></a>
...
##### `repository`<sup>Optional</sup> <a name="repository" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.repository"></a>
...
##### `repositoryDirectory`<sup>Optional</sup> <a name="repositoryDirectory" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.repositoryDirectory"></a>
...
##### `scopedPackagesOptions`<sup>Optional</sup> <a name="scopedPackagesOptions" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.scopedPackagesOptions"></a>
...
##### ~~`scripts`~~<sup>Optional</sup> <a name="scripts" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.scripts"></a>
...
##### `stability`<sup>Optional</sup> <a name="stability" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.stability"></a>
...
##### `yarnBerryOptions`<sup>Optional</sup> <a name="yarnBerryOptions" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.yarnBerryOptions"></a>
...
##### `jsiiReleaseVersion`<sup>Optional</sup> <a name="jsiiReleaseVersion" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.jsiiReleaseVersion"></a>
...
##### `majorVersion`<sup>Optional</sup> <a name="majorVersion" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.majorVersion"></a>
...
##### `minMajorVersion`<sup>Optional</sup> <a name="minMajorVersion" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.minMajorVersion"></a>
...
##### `npmDistTag`<sup>Optional</sup> <a name="npmDistTag" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.npmDistTag"></a>
...
##### `postBuildSteps`<sup>Optional</sup> <a name="postBuildSteps" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.postBuildSteps"></a>
...
##### `prerelease`<sup>Optional</sup> <a name="prerelease" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.prerelease"></a>
...
##### `publishDryRun`<sup>Optional</sup> <a name="publishDryRun" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.publishDryRun"></a>
...
##### `publishTasks`<sup>Optional</sup> <a name="publishTasks" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.publishTasks"></a>
...
##### `releasableCommits`<sup>Optional</sup> <a name="releasableCommits" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.releasableCommits"></a>
...
##### `releaseBranches`<sup>Optional</sup> <a name="releaseBranches" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.releaseBranches"></a>
...
##### ~~`releaseEveryCommit`~~<sup>Optional</sup> <a name="releaseEveryCommit" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.releaseEveryCommit"></a>
...
##### `releaseFailureIssue`<sup>Optional</sup> <a name="releaseFailureIssue" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.releaseFailureIssue"></a>
...
##### `releaseFailureIssueLabel`<sup>Optional</sup> <a name="releaseFailureIssueLabel" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.releaseFailureIssueLabel"></a>
...
##### ~~`releaseSchedule`~~<sup>Optional</sup> <a name="releaseSchedule" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.releaseSchedule"></a>
...
##### `releaseTagPrefix`<sup>Optional</sup> <a name="releaseTagPrefix" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.releaseTagPrefix"></a>
...
##### `releaseTrigger`<sup>Optional</sup> <a name="releaseTrigger" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.releaseTrigger"></a>
...
##### `releaseWorkflowName`<sup>Optional</sup> <a name="releaseWorkflowName" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.releaseWorkflowName"></a>
...
##### `releaseWorkflowSetupSteps`<sup>Optional</sup> <a name="releaseWorkflowSetupSteps" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.releaseWorkflowSetupSteps"></a>
...
##### `versionrcOptions`<sup>Optional</sup> <a name="versionrcOptions" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.versionrcOptions"></a>
...
##### `workflowContainerImage`<sup>Optional</sup> <a name="workflowContainerImage" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.workflowContainerImage"></a>
...
##### `workflowRunsOn`<sup>Optional</sup> <a name="workflowRunsOn" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.workflowRunsOn"></a>
...
##### `workflowRunsOnGroup`<sup>Optional</sup> <a name="workflowRunsOnGroup" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.workflowRunsOnGroup"></a>
...
##### `defaultReleaseBranch`<sup>Required</sup> <a name="defaultReleaseBranch" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.defaultReleaseBranch"></a>
...
##### `artifactsDirectory`<sup>Optional</sup> <a name="artifactsDirectory" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.artifactsDirectory"></a>
...
##### `autoApproveUpgrades`<sup>Optional</sup> <a name="autoApproveUpgrades" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.autoApproveUpgrades"></a>
...
##### `buildWorkflow`<sup>Optional</sup> <a name="buildWorkflow" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.buildWorkflow"></a>
...
##### `buildWorkflowTriggers`<sup>Optional</sup> <a name="buildWorkflowTriggers" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.buildWorkflowTriggers"></a>
...
##### `bundlerOptions`<sup>Optional</sup> <a name="bundlerOptions" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.bundlerOptions"></a>
...
##### `checkLicenses`<sup>Optional</sup> <a name="checkLicenses" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.checkLicenses"></a>
...
##### `codeCov`<sup>Optional</sup> <a name="codeCov" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.codeCov"></a>
...
##### `codeCovTokenSecret`<sup>Optional</sup> <a name="codeCovTokenSecret" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.codeCovTokenSecret"></a>
...
##### `copyrightOwner`<sup>Optional</sup> <a name="copyrightOwner" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.copyrightOwner"></a>
...
##### `copyrightPeriod`<sup>Optional</sup> <a name="copyrightPeriod" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.copyrightPeriod"></a>
...
##### `dependabot`<sup>Optional</sup> <a name="dependabot" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.dependabot"></a>
...
##### `dependabotOptions`<sup>Optional</sup> <a name="dependabotOptions" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.dependabotOptions"></a>
...
##### `depsUpgrade`<sup>Optional</sup> <a name="depsUpgrade" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.depsUpgrade"></a>
...
##### `depsUpgradeOptions`<sup>Optional</sup> <a name="depsUpgradeOptions" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.depsUpgradeOptions"></a>
...
##### `gitignore`<sup>Optional</sup> <a name="gitignore" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.gitignore"></a>
...
##### `jest`<sup>Optional</sup> <a name="jest" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.jest"></a>
...
##### `jestOptions`<sup>Optional</sup> <a name="jestOptions" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.jestOptions"></a>
...
##### `mutableBuild`<sup>Optional</sup> <a name="mutableBuild" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.mutableBuild"></a>
...
##### ~~`npmignore`~~<sup>Optional</sup> <a name="npmignore" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.npmignore"></a>
...
##### `npmignoreEnabled`<sup>Optional</sup> <a name="npmignoreEnabled" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.npmignoreEnabled"></a>
...
##### `npmIgnoreOptions`<sup>Optional</sup> <a name="npmIgnoreOptions" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.npmIgnoreOptions"></a>
...
##### `package`<sup>Optional</sup> <a name="package" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.package"></a>
...
##### `prettier`<sup>Optional</sup> <a name="prettier" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.prettier"></a>
...
##### `prettierOptions`<sup>Optional</sup> <a name="prettierOptions" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.prettierOptions"></a>
...
##### `projenDevDependency`<sup>Optional</sup> <a name="projenDevDependency" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.projenDevDependency"></a>
...
##### `projenrcJs`<sup>Optional</sup> <a name="projenrcJs" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.projenrcJs"></a>
...
##### `projenrcJsOptions`<sup>Optional</sup> <a name="projenrcJsOptions" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.projenrcJsOptions"></a>
...
##### `projenVersion`<sup>Optional</sup> <a name="projenVersion" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.projenVersion"></a>
...
##### `pullRequestTemplate`<sup>Optional</sup> <a name="pullRequestTemplate" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.pullRequestTemplate"></a>
...
##### `pullRequestTemplateContents`<sup>Optional</sup> <a name="pullRequestTemplateContents" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.pullRequestTemplateContents"></a>
...
##### `release`<sup>Optional</sup> <a name="release" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.release"></a>
...
##### `releaseToNpm`<sup>Optional</sup> <a name="releaseToNpm" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.releaseToNpm"></a>
...
##### ~~`releaseWorkflow`~~<sup>Optional</sup> <a name="releaseWorkflow" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.releaseWorkflow"></a>
...
##### `workflowBootstrapSteps`<sup>Optional</sup> <a name="workflowBootstrapSteps" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.workflowBootstrapSteps"></a>
...
##### `workflowGitIdentity`<sup>Optional</sup> <a name="workflowGitIdentity" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.workflowGitIdentity"></a>
...
##### `workflowNodeVersion`<sup>Optional</sup> <a name="workflowNodeVersion" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.workflowNodeVersion"></a>
...
##### `workflowPackageCache`<sup>Optional</sup> <a name="workflowPackageCache" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.workflowPackageCache"></a>
...
##### `disableTsconfig`<sup>Optional</sup> <a name="disableTsconfig" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.disableTsconfig"></a>
...
##### `disableTsconfigDev`<sup>Optional</sup> <a name="disableTsconfigDev" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.disableTsconfigDev"></a>
...
##### `docgen`<sup>Optional</sup> <a name="docgen" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.docgen"></a>
...
##### `docsDirectory`<sup>Optional</sup> <a name="docsDirectory" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.docsDirectory"></a>
...
##### `entrypointTypes`<sup>Optional</sup> <a name="entrypointTypes" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.entrypointTypes"></a>
...
##### `eslint`<sup>Optional</sup> <a name="eslint" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.eslint"></a>
...
##### `eslintOptions`<sup>Optional</sup> <a name="eslintOptions" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.eslintOptions"></a>
...
##### `libdir`<sup>Optional</sup> <a name="libdir" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.libdir"></a>
...
##### `projenrcTs`<sup>Optional</sup> <a name="projenrcTs" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.projenrcTs"></a>
...
##### `projenrcTsOptions`<sup>Optional</sup> <a name="projenrcTsOptions" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.projenrcTsOptions"></a>
...
##### `sampleCode`<sup>Optional</sup> <a name="sampleCode" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.sampleCode"></a>
...
##### `srcdir`<sup>Optional</sup> <a name="srcdir" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.srcdir"></a>
...
##### `testdir`<sup>Optional</sup> <a name="testdir" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.testdir"></a>
...
##### `tsconfig`<sup>Optional</sup> <a name="tsconfig" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.tsconfig"></a>
...
##### `tsconfigDev`<sup>Optional</sup> <a name="tsconfigDev" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.tsconfigDev"></a>
...
##### `tsconfigDevFile`<sup>Optional</sup> <a name="tsconfigDevFile" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.tsconfigDevFile"></a>
...
##### `tsJestOptions`<sup>Optional</sup> <a name="tsJestOptions" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.tsJestOptions"></a>
...
##### `typescriptVersion`<sup>Optional</sup> <a name="typescriptVersion" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.typescriptVersion"></a>
...
##### `buildCommand`<sup>Optional</sup> <a name="buildCommand" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.buildCommand"></a>
...
##### `cdkout`<sup>Optional</sup> <a name="cdkout" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.cdkout"></a>
...
##### `context`<sup>Optional</sup> <a name="context" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.context"></a>
...
##### `featureFlags`<sup>Optional</sup> <a name="featureFlags" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.featureFlags"></a>
...
##### `requireApproval`<sup>Optional</sup> <a name="requireApproval" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.requireApproval"></a>
...
##### `watchExcludes`<sup>Optional</sup> <a name="watchExcludes" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.watchExcludes"></a>
...
##### `watchIncludes`<sup>Optional</sup> <a name="watchIncludes" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.watchIncludes"></a>
...
##### `cdkVersion`<sup>Required</sup> <a name="cdkVersion" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.cdkVersion"></a>
...
##### ~~`cdkAssert`~~<sup>Optional</sup> <a name="cdkAssert" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.cdkAssert"></a>
...
##### `cdkAssertions`<sup>Optional</sup> <a name="cdkAssertions" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.cdkAssertions"></a>
...
##### ~~`cdkDependencies`~~<sup>Optional</sup> <a name="cdkDependencies" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.cdkDependencies"></a>
...
##### ~~`cdkDependenciesAsDeps`~~<sup>Optional</sup> <a name="cdkDependenciesAsDeps" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.cdkDependenciesAsDeps"></a>
...
##### ~~`cdkTestDependencies`~~<sup>Optional</sup> <a name="cdkTestDependencies" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.cdkTestDependencies"></a>
...
##### `cdkVersionPinning`<sup>Optional</sup> <a name="cdkVersionPinning" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.cdkVersionPinning"></a>
...
##### `constructsVersion`<sup>Optional</sup> <a name="constructsVersion" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.constructsVersion"></a>
...
##### `appEntrypoint`<sup>Optional</sup> <a name="appEntrypoint" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.appEntrypoint"></a>
...
##### `edgeLambdaAutoDiscover`<sup>Optional</sup> <a name="edgeLambdaAutoDiscover" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.edgeLambdaAutoDiscover"></a>
...
##### `experimentalIntegRunner`<sup>Optional</sup> <a name="experimentalIntegRunner" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.experimentalIntegRunner"></a>
...
##### `integrationTestAutoDiscover`<sup>Optional</sup> <a name="integrationTestAutoDiscover" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.integrationTestAutoDiscover"></a>
...
##### `lambdaAutoDiscover`<sup>Optional</sup> <a name="lambdaAutoDiscover" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.lambdaAutoDiscover"></a>
...
##### `lambdaExtensionAutoDiscover`<sup>Optional</sup> <a name="lambdaExtensionAutoDiscover" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.lambdaExtensionAutoDiscover"></a>
...
##### `lambdaOptions`<sup>Optional</sup> <a name="lambdaOptions" id="ts-cdk-pipeline-app.CDKPipelineAppOptions.property.lambdaOptions"></a>
